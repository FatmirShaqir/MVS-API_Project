...
namespace BSCodeModels_Lib
{
    ...
    public class About
    {
        ...
        [StringLength(250, MinimumLength = 5, ErrorMessage = "Short Description must be between 50 and 20 characters!")]
        public string ShortDescription { get; set; }

        [Display(Name = "Long description:", Prompt = "Enter a long description")]
        [StringLength(1000, MinimumLength = 5, ErrorMessage = "Long Description must be between 50 and 20 characters!")]
